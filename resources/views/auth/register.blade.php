    ...
    <div class="auth-shell">
        ...
        <div class="auth-panel">
            <form method="POST" action="{{ route('register') }}" novalidate>
                ...
                <div class="mb-3">
                    <label class="form-label" for="municipality_name">Nome do município <span class="required-mark">*</span></label>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-12 col-md-5">
                        <label class="form-label" for="state">UF <span class="required-mark">*</span></label>
                    ...
                    <div class="col-12 col-md-7">
                        <label class="form-label" for="ibge_code">Código IBGE <span class="required-mark">*</span></label>
                ...
                <div class="mb-4">
                    <label class="form-label" for="cnpj">CNPJ principal <span class="required-mark">*</span></label>
