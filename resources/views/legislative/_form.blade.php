...
<div class="legislative-simple-form">
    <section class="legislative-form-section span-2">
        ...
        <div class="legislative-fields">
            ...
            <label><span>Secretaria ou orgao executor <b>*</b></span><input class="form-control @error('responsible_department') is-invalid @enderror" name="responsible_department" value="{{ old('responsible_department', $proposal->responsible_department ?? '') }}" maxlength="255" required placeholder="Ex.: Secretaria de Saude" @if($institutionSuggestions['departments']->isNotEmpty()) list="legislative-departments" @endif data-auto-department data-institution-source="legislative-departments">@error('responsible_department')<small class="invalid-feedback">{{ $message }}</small>@enderror</label>
