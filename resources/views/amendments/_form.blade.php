...
<section class="form-section">
    <div class="form-section-heading"><span>3</span><h2 class="h5 mb-0">Valores e situação</h2></div>
    <div class="row g-3">
        <div class="col-md-4">
...
<section class="form-section">
    <div class="form-section-heading"><span>4</span><h2 class="h5 mb-0">Prazos de controle</h2></div>
    <div class="row g-3">
        <div class="col-md-4">
