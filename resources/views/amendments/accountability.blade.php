            ...
            @if ($canEdit && $readiness['ready'])
                <form class="accountability-submit-form" method="POST" action="{{ route('emendas.accountability.submit', $amendment) }}" data-prevent-double-submit>
                    ...
                    <div>
                        ...
                        <input class="form-control @error('protocol_number') is-invalid @enderror" id="quick_protocol_number" name="protocol_number" value="{{ old('protocol_number', $process->protocol_number ?: $protocolSuggestion) }}" maxlength="100" required>
            ...
            @if ($canEdit)
                <form class="accountability-process-form" method="POST" action="{{ route('emendas.accountability.update', $amendment) }}" data-prevent-double-submit novalidate>
                    ...
                    <div class="accountability-process-grid">
                        ...
                        <div class="span-2"><label class="form-label" for="protocol_number">Protocolo de envio</label><input class="form-control @error('protocol_number') is-invalid @enderror" id="protocol_number" name="protocol_number" value="{{ old('protocol_number', $process->protocol_number ?: $protocolSuggestion) }}" maxlength="100">@error('protocol_number')<div class="invalid-feedback">{{ $message }}</div>@enderror</div>
