...
class LegislativeProposalTest extends TestCase
{
    ...
    public function test_portal_uses_available_active_year_instead_of_unconfigured_next_year(): void
    {
        ...
        $this->actingAs($councilor)->withSession(['active_municipality_id' => $municipality->id])
            ...
            ->assertSee('Atalhos do Portal Legislativo')
            ->assertSee('#resumo-vereador', false)
            ->assertSee('#acompanhamento-vereador', false)
            ->assertSee('Pronto para indicar')
            ->assertSee('Uso da cota')
            ->assertSee('Reserva mínima de saúde')
            ->assertSee('Resumo automático para o vereador')
    ...
    public function test_create_screen_projects_available_quota_and_recommends_health_automatically(): void
    {
        ...
        $this->actingAs($councilor)->withSession(['active_municipality_id' => $municipality->id])
            ...
            ->assertSee('data-institution-source="legislative-beneficiaries"', false)
            ->assertSee('data-institution-location-target', false)
    ...
    public function test_councilor_submission_assistant_guides_draft_and_returned_proposal(): void
    {
        ...
        $this->actingAs($councilor)
            ...
            ->assertSee('Enviar para conferência da Câmara')
    ...
    public function test_complete_legislative_to_executive_flow_creates_amendment_and_budget_reservation(): void
    {
        ...
        $this->actingAs($manager)->withSession(['active_municipality_id' => $municipality->id])
            ...
            ->assertSee(route('emendas.work-plan', $proposal->amendment), false)
            ->assertSee('Abrir execução')
            ->assertSee(route('emendas.execution', $proposal->amendment), false)
            ->assertSee('Abrir prestação')
            ->assertSee(route('emendas.accountability', $proposal->amendment), false)
        ...
        $this->actingAs($councilor)->withSession(['active_municipality_id' => $municipality->id])
            ...
            ->assertSee('Fechamento da sua indicação')
            ->assertSee('Execução e prestação em linguagem simples')
            ->assertSee('Entrega física')
            ->assertSee('Valor pago')
            ->assertSee('Prestação')
            ->assertSee('Ver acompanhamento final')
    ...
    public function test_executive_sees_single_board_for_chamber_intake_and_councilor_keeps_simple_view(): void
    {
        ...
        $this->actingAs($manager)
            ...
            ->assertSee('#mesa-executivo', false)
            ->assertSee('#fila-executivo', false)
            ->assertSee('#kanban-executivo', false)
            ->assertSee('Decisão, recebimento e reserva em uma fila')
            ->assertSee('Conferência da Câmara')
            ->assertSee('Receber no Executivo')
            ->assertSee('Reservar orçamento')
            ->assertSee('Prioridade inteligente do Executivo')
            ->assertSee('Próxima decisão sugerida')
            ->assertSee('Conferir a proposta da Câmara')
            ->assertSee('A proposta precisa de validação legislativa')
            ->assertSee('Conferência')
            ->assertSee('Recebimento')
            ->assertSee('Reserva')
            ->assertSee('Execução')
            ->assertSee('Protocolos aguardando processo')
            ->assertSee('Dotação precisa ser confirmada')
            ->assertSee('Sem execução aberta')
            ->assertSee('Fluxo operacional')
            ->assertSee('Depois da prioridade, acompanhe por etapa')
            ->assertSee('Use os quatro passos abaixo')
            ->assertSee('Voltar ao foco')
        ...
        $this->actingAs($councilor)
            ...
            ->assertSee('Central simples do vereador')
            ->assertSee('O que fazer agora')
            ->assertSee('Saúde automática')
            ->assertSee('Criar com orientação')
            ->assertSee('Abrir esteira')
            ->assertSee('1. Criar pedido')
            ->assertSee('2. Acompanhar andamento')
            ->assertSee('3. Entender saldo')
            ->assertSee('Criar agora')
            ->assertSee('Ver explicação')
    ...
    public function test_councilor_portal_groups_proposals_by_next_step(): void
    {
        ...
        $this->actingAs($councilor)
            ...
            ->assertSee('O que fazer agora')
            ->assertSee('Saúde automática')
            ->assertSee('Resumo do mandato')
            ->assertSee('Dinheiro, saúde e andamento em uma tela')
            ->assertSee('Linha do tempo das propostas')
            ->assertSee('Rascunho ou ajuste')
            ->assertSee('Precisa de você')
            ...
            ->assertSee('Visão simples do vereador')
            ...
            ->assertSee('Corrigir devolução')
            ->assertSee('Em conferência na Câmara')
    ...
    public function test_executive_desk_shows_focus_metrics_and_action_shortcuts(): void
    {
        ...
        $this->actingAs($manager)
            ...
            ->assertSee('Resumo decisório do Executivo')
            ->assertSee('Decisão agora')
            ->assertSee('Condição para avançar')
            ->assertSee('Atalho certo')
            ->assertSee('Fila rápida habilitada')
            ->assertSee('Abrir fila rápida')
            ...
            ->assertSee('Fila rápida de atendimento')
            ...
            ->assertSee('Próximo automático')
            ->assertSee('Receber como processo')
            ->assertSee('Registrar reserva orçamentária')
            ->assertSee('Abrir plano de trabalho')
