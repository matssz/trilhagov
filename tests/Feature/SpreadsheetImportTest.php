...
class SpreadsheetImportTest extends TestCase
{
        ...
        $this->actingAs($manager)->post(route('spreadsheet-imports.preview'), [
            ...
            'spreadsheet' => UploadedFile::fake()->createWithContent('controle.csv', $this->csv([
                $this->validRow([
                    ...
                    'Codigo Transferegov' => '',
                    'Destinacao (custeio ou investimento)' => 'Investimento',
                    'Municipio ou localidade beneficiada' => 'Municipio de Teste',
                    'Processo administrativo' => 'PROC-IMPORT-001',
                    'Rastreabilidade bancaria' => 'Execucao direta com codigos',
                    'Fonte de Recursos' => '08',
                    'Codigo de Aplicacao Fixo' => '100.0000',
                    'Codigo de Aplicacao Variavel' => '001',
                    'Prazo de aplicacao dos recursos' => '31/12/2026',
                ]),
    ...
    private function validRow(array $overrides = []): array
    {
        return array_merge([
            ...
            'Destinacao (custeio ou investimento)' => '',
            ...
            'Fonte de Recursos' => '',
            'Codigo de Aplicacao Fixo' => '',
            'Codigo de Aplicacao Variavel' => '',
            ...
            'Prazo de aplicacao dos recursos' => '',
