...
class AccountabilityTest extends TestCase
{
    ...
    public function test_simplified_accountability_pre_checks_execution_financial_and_evidence(): void
    {
        ...
        $this->actingAs($manager)
            ...
            ->assertSee('Comando final')
            ->assertSee('Fechamento ainda precisa de decisão')
        ...
        $this->get(route('emendas.accountability', $amendment))
            ...
            ->assertSee('Pronta para protocolo e arquivo')
            ->assertSee('Protocolar agora')
            ->assertSee('Pacote de anexos')
