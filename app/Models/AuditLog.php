...
class AuditLog extends Model
{
    ...
    public function actionLabel(): string
    {
        return match ($this->action) {
            ...
            'internal_control_review_issued' => 'Parecer do Controle Interno emitido',
            'internal_control_action_responded' => 'Providência do Controle Interno respondida',
            'internal_control_action_decided' => 'Saneamento do Controle Interno avaliado',
            ...
            'municipal_modules_updated' => 'Módulos municipais atualizados',
    ...
    private static function fieldLabels(): array
    {
        return [
            ...
            'federal_amendments_enabled' => 'Modulo de emendas federais',
            'state_amendments_enabled' => 'Modulo de emendas estaduais',
            'health_asps_module_enabled' => 'Modulo avancado de saude',
            'contracts_module_enabled' => 'Modulo de obras e contratos',
            'audit_module_enabled' => 'Modulo de controle interno avancado',
            'specialized_reports_enabled' => 'Modulo de relatorios especializados',
            'spreadsheet_import_enabled' => 'Modulo de importacao',
            'document_checklist_enabled' => 'Modulo de checklist documental',
            ...
            'internal_control_reference' => 'Referência do parecer interno',
            'internal_control_phase' => 'Fase da verificação interna',
            'internal_control_conclusion' => 'Conclusão do Controle Interno',
            'internal_control_action_id' => 'Providência do Controle Interno',
            'internal_control_response' => 'Resposta à providência',
            'internal_control_action_status' => 'Situação da providência',
            'internal_control_resolution' => 'Decisão sobre o saneamento',
            'snapshot_sha256' => 'Hash da fotografia',
