...
class MunicipalGovernanceReportService
{
    ...
    private function amendmentRow(ParliamentaryAmendment $amendment, Carbon $periodEnd): array
    {
        ...
        return [
            ...
            'government_sphere' => $amendment->government_sphere,
            'authorship_type' => $amendment->authorship_type,
            'regulatory_profile_id' => $amendment->municipal_regulatory_profile_id,
            ...
            'work_plan_health_related' => $amendment->municipalWorkPlan?->health_related,
