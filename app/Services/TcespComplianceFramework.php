...
class TcespComplianceFramework
{
    ...
    {
        return match ($code) {
            'NORM-01' => ['Lei Orgânica atualizada', 'LDO ou LOA do exercício', 'ato municipal com limite, reserva da saúde e hipóteses de impedimento'],
            'NORM-02' => ['regimento interno da Câmara', 'decreto ou instrução normativa do Executivo', 'calendário oficial de análise e saneamento'],
            'ORC-01' => ['descrição técnica do objeto', 'justificativa da entrega pública', 'parecer que afaste objeto genérico'],
            'ORC-02' => ['vínculo com programa e ação da LOA', 'manifestação da secretaria executora', 'classificação orçamentária sugerida'],
            'ORC-03' => ['análise da natureza da despesa', 'declaração de não duplicidade', 'memória da origem orçamentária'],
            'VIA-01' => ['meta física mensurável', 'indicador de resultado', 'público beneficiado e local da entrega'],
            'VIA-02' => ['orçamento estimativo', 'pesquisa de preços', 'demonstração de etapa útil e funcional'],
            'VIA-03' => ['projeto básico ou termo de referência', 'licença ou dispensa fundamentada', 'estimativa de custos acessórios'],
            'VIA-04' => ['declaração da secretaria sobre custeio futuro', 'plano de manutenção', 'impacto operacional previsto'],
            'PLAN-01' => ['plano de trabalho assinado', 'identificação do autor', 'dados do beneficiário ou órgão executor'],
            'PLAN-02' => ['justificativa da necessidade pública', 'diagnóstico local', 'relação com política pública municipal'],
            'PLAN-03' => ['cronograma físico-financeiro', 'etapas com datas', 'desembolsos previstos por fase'],
            'PLAN-04' => ['plano de aplicação', 'memória de cálculo', 'planilha de custos detalhada'],
            'BEN-01' => ['CNPJ e atos constitutivos', 'certidões de regularidade', 'comprovação de capacidade técnica'],
            'BEN-02' => ['declaração de inexistência de nepotismo', 'comprovante de conta específica', 'ata ou relação de dirigentes'],
            'SAU-01' => ['parecer ASPS', 'classificação da despesa de saúde', 'demonstrativo da reserva mínima'],
            'IMP-01' => ['parecer de admissibilidade da Câmara', 'ata ou despacho legislativo', 'fundamentação da aprovação ou rejeição'],
            'IMP-02' => ['parecer técnico do Executivo', 'classificação do impedimento', 'documentos que comprovem o óbice'],
            'IMP-03' => ['ofício de notificação', 'protocolo de ciência', 'resposta do autor ou remanejamento aprovado'],
            'TRA-01' => ['link do portal de transparência', 'captura ou recibo de publicação', 'histórico de atualização'],
            'TRA-02' => ['cadastro Audesp preparado', 'recibo ou protocolo de envio', 'retorno de homologação'],
            'TRA-03' => ['códigos contábeis individualizados', 'empenhos, liquidações e pagamentos', 'extrato ou justificativa de execução direta'],
            'CON-01' => ['contrato ou instrumento equivalente', 'nota fiscal, medição ou ateste', 'termo de recebimento e comprovante de pagamento'],
            'CON-02' => ['revisão do controle interno', 'providências abertas e saneadas', 'relatório conclusivo de acompanhamento'],
            default => match ($category) {
                'normative' => ['norma municipal aplicável', 'ato de regulamentação', 'parecer jurídico'],
                'budget' => ['classificação orçamentária', 'justificativa técnica', 'documento da secretaria responsável'],
                'viability' => ['estudo técnico', 'orçamento estimativo', 'manifestação do setor executor'],
                'work_plan' => ['plano de trabalho', 'cronograma', 'memória de cálculo'],
                'beneficiary' => ['documentos do beneficiário', 'certidões', 'parecer de regularidade'],
                'impediments' => ['parecer técnico', 'ofício de notificação', 'protocolo de resposta'],
                'traceability' => ['publicação no portal', 'registro Audesp', 'rastreio contábil'],
                default => ['relatório de controle', 'documentos de execução', 'parecer conclusivo'],
            },
        };
    }
}
